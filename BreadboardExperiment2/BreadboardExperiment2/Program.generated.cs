...
namespace BreadboardExperiment2 {
    ...
    public partial class Program : Gadgeteer.Program {
        ...
        /// <summary>The USB Client EDP module using socket 2 of the mainboard.</summary>
        private Gadgeteer.Modules.GHIElectronics.USBClientEDP usbClientEDP;
        
        /// <summary>The BreadBoard X1 module using socket 14 of the mainboard.</summary>
        ...
        private void InitializeModules() {
            this.usbClientEDP = new GTM.GHIElectronics.USBClientEDP(2);
            this.breadBoardX1 = new GTM.GHIElectronics.BreadBoardX1(14);
        }
    }
}
